...
def test_deauthorize_redirect(mock_oauth_client, mock_request):
    ...
    result = deauthorize_redirect(mock_request, mock_oauth_client, "token", "https://localhost/redirect_uri")
...
def test_deauthorize_redirect_load_server_metadata_error(mock_oauth_client, mock_request):
    ...
    with pytest.raises(Exception):
        deauthorize_redirect(mock_request, mock_oauth_client, "token", "https://localhost/redirect_uri")
